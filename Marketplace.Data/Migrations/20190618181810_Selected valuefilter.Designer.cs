...
namespace Marketplace.Data.Migrations
{
    ...
    [Migration("20190618181810_Selected valuefilter")]
    partial class Selectedvaluefilter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketplace.Model.Models.FilterBooleanValue", b =>
                {
                    ...
                    b.Property<int?>("FilterBooleanId");
                    ...
                    b.HasIndex("FilterBooleanId")
                        .IsUnique()
                        .HasFilter("[FilterBooleanId] IS NOT NULL");
            ...
            modelBuilder.Entity("Marketplace.Model.Models.FilterRangeValue", b =>
                {
                    ...
                    b.HasIndex("FilterRangeId")
                        .IsUnique()
                        .HasFilter("[FilterRangeId] IS NOT NULL");
            ...
            modelBuilder.Entity("Marketplace.Model.Models.FilterTextValue", b =>
                {
                    ...
                    b.Property<int?>("SelectedFilterTextId");
                    ...
                    b.HasIndex("SelectedFilterTextId")
                        .IsUnique()
                        .HasFilter("[SelectedFilterTextId] IS NOT NULL");
            ...
            modelBuilder.Entity("Marketplace.Model.Models.FilterBooleanValue", b =>
                {
                    b.HasOne("Marketplace.Model.Models.FilterBoolean", "FilterBoolean")
                        .WithOne("FilterBooleanValue")
                        .HasForeignKey("Marketplace.Model.Models.FilterBooleanValue", "FilterBooleanId");
            ...
            modelBuilder.Entity("Marketplace.Model.Models.FilterRangeValue", b =>
                {
                    b.HasOne("Marketplace.Model.Models.FilterRange", "FilterRange")
                        .WithOne("FilterRangeValue")
                        .HasForeignKey("Marketplace.Model.Models.FilterRangeValue", "FilterRangeId");
            ...
            modelBuilder.Entity("Marketplace.Model.Models.FilterTextValue", b =>
                {
                    ...
                    b.HasOne("Marketplace.Model.Models.FilterText", "SelectedFilterText")
                        .WithOne("FilterTextValue")
                        .HasForeignKey("Marketplace.Model.Models.FilterTextValue", "SelectedFilterTextId");
                });
